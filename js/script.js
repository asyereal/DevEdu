...
function parse_level(a){
	document.getElementById("text_parser").value = a;
	console.log(document.getElementById("text_parser").value);
	switch (a){
		case "Primary":
			document.getElementById("level_parser").value = "Prim";
			break;
		case "Secondary":
			document.getElementById("level_parser").value = "Sec";
			break;
	}
}
