export default class NotesView {
    ...
    _createListItemHTML(id, title, body, updated) {
        ...
        return `
            <div class="notes_list-item" data-note-id="${id}">
                ...
                <button type=button class="notes_delete">Delete Note</button>
            </div>
        `;
    }
    ...
    updateNoteList(notes) {
        ...
        //const notesDeleteButton = this.root.querySelector(".notes_delete");
        ...
        notesListContainer.querySelectorAll(".notes_list-item").forEach(noteListItem => {
            ...
            noteListItem.querySelector(".notes_delete").addEventListener("click", () => {
